...
const FAQS = [
  ...
  { q: "유지 보장이나 리필이 있나요?", a: "네, 대부분의 상품에 유지 보장과 자연 감소 시 무료 리필을 제공합니다. 보장 기간은 상품별로 다르며(인스타·틱톡·X 30일, 유튜브·텔레그램 60일 등) 각 상품 페이지에서 확인하실 수 있습니다. 보장 기간 내 감소분은 무료로 리필해 드리며, 리필이 어려운 일부 상품은 부족분을 환불해 드립니다." },
...
useSeoMeta({
  ...
  // 카카오톡(주력 매출축) 포함, title·H1·첫 설명 주제 정렬
  title: "SNS 마케팅 — 인스타·카카오톡·유튜브·틱톡 팔로워·채널 늘리기",
  description:
    "인스타·카카오톡·유튜브·틱톡·텔레그램 마케팅을 한 곳에서. 실제 한국인 계정 기반으로 팔로워·구독자·채널 친구를 안전하게 늘려드립니다. 자연 감소 시 무료 리필 보장(상품별 30~60일), 결제 후 10분 내 시작, 결과보고서까지 투명하게 제공합니다.",
